    ...
    <aside :class="['sidebar', { 'sidebar--collapsed': sidebarCollapsed }]">
      ...
      <nav class="sidebar__nav">
        ...
        >
          ...
          <span v-if="!sidebarCollapsed" class="nav-item__label">{{
            item.label
          }}</span>
          <span
      ...
      <div class="sidebar__footer">
        <div class="connection-status">
          <div
            :class="['status-dot', { 'status-dot--active': isConnected }]"
          ></div>
          ...
          <div class="topbar__item topbar__notifications">
            ...
            >
              <div class="dropdown__header">
                <h3>Notifications</h3>
                <button @click="markAllAsRead" class="text-btn">
                  Mark all read
                </button>
              </div>
              ...
              <div class="dropdown__footer">
                <router-link to="/alerts" class="link"
    ...
    const navigationItems = computed(() => {
      const items = [
        ...
        { path: "/devices", label: "Devices", icon: Cpu },
        {
          ...
          label: "Alerts",
          icon: Bell,
          badge: alertsStore.totalUnresolvedCount,
          badgeType: "danger",
        },
