  ...
  <div class="alerts-view">
    ...
    <div class="alert-stats">
      <div class="stat-card stat-card--info">
        ...
        <div class="stat-content">
          <p class="stat-value">{{ alertCounts.total }}</p>
      ...
      <div class="filter-controls">
        <select v-model="filterDevice" class="filter-select">
          ...
          <option
            ...
            :value="device._id || device.device_id"
          >
    ...
    <div v-else class="alerts-list">
      <AlertItem
        ...
        :alert="alert"
        :show-details="true"
        :allow-delete="activeTab === 'resolved'"
    ...
    const tabs = computed(() => [
      {
        label: "Unresolved",
        value: "unresolved",
        count: alertsStore.unresolvedAlerts.length,
      },
      { label: "All Alerts", value: "all", count: null },
      {
        label: "Resolved",
        value: "resolved",
        count: alertsStore.resolvedAlerts.length,
      },
    ]);
